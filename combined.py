...
with tab7:
    ...
    if not uploaded_doc or not uploaded_wisc:
        ...
        if st.button("Generate Combined Report"):
            ...
            # Produces per-name placeholders:
            #   {{WISC Block Design SW}}        → "Strength", "Weakness", or "-"
            #   {{WISC Verbal Comprehension SW}} → "Strength", "Weakness", or "-"
            INDEX_FULL = {}   # abbrev → full name, e.g. {"VCI": "Verbal Comprehension"}
            SUBTEST_FULL = {} # abbrev → full name, e.g. {"SI": "Similarities"}
            ...
            for i, table in enumerate(input_wisc_doc.tables):
                ...
                # --- Index Level S&W → {{WISC <Full Name> SW}} ---
                    ...
                    for row in table.rows[2:]:
                        ...
                        if sw_flag == "S":
                            ...
                            value = "-"
                        lookup[f"WISC {full_name} SW"] = value

                # --- Subtest Level S&W → {{WISC <Full Name> SW}} ---
